      ...
      <div className="container max-w-[1200px] mx-auto px-5 py-10">
        ...
        >
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bento-item projects-section bg-white p-10 text-center transition-all duration-300 cursor-pointer relative overflow-hidden md:rounded-bl-[17px] hover:-translate-y-0.5 hover:shadow-[0_5px_15px_rgba(249,200,177,0.3)] block"
          >
            <div className="relative z-10">
              <span className="text-[40px] mb-[15px] block hover:animate-wiggle">🥡</span>
              <h3 className="text-2xl font-semibold mb-[10px]" style={{ color: '#593B2B' }}>
